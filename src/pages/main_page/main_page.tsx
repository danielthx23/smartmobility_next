  ...
  return (
    ...
    <section className="p-0 md:p-4">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-16 gap-y-4 bg-[#E2DEDC] px-12 py-12 rounded-2xl">
        ...
        <Link href="/pages/localizacao" className="icon-container bg-[#5BC7CA] hidden lg:flex justify-center items-center flex-col gap-12 py-12 px-4 rounded-md text-center font-lilita">
          <FaLocationDot className="text-black" size={96}/>
          <p className="text-3xl text-black">Minha localização</p>
        </Link>

        <Link href="/pages/mapa_metro" className="icon-container bg-[#5BC7CA] hidden lg:flex justify-center items-center flex-col gap-12 py-12 px-4 rounded-md text-center font-lilita">
        ...
        <Link href="/pages/chat_metro" className="icon-container bg-[#5BC7CA] hidden lg:flex justify-center items-center flex-col gap-12 py-12 px-4 rounded-md text-center font-lilita">
        ...
        <Link href="/pages/escolha" className="icon-container bg-[#5BC7CA] hidden lg:flex justify-center items-center flex-col gap-12 py-12 px-4 rounded-md text-center font-lilita">
